...
#first row in the ans suggests that 52% of the ppl who got baking powder also buys whole milk. Also this is .9252 % of the total transactions and the this category transaction count is 91
#lift is number of times the lhs and rhs bought together divided by product of number of rhs and lhs bought respectively
rules
inspect (rules[1:5])
